                ...
                <div class="col-11">
                    ...
                    <form action="{{ route('admin.projects.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="programmingLanguages" name="programming_languages">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="creationDay" name="creation_day">
                            <div id="dateHelp" class="form-text">Insert the creation date of your project.</div>
                        </div>

                        <button type="submit" action class="btn btn-primary">Create Project</button>
